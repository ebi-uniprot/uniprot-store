...
INSERT INTO SPTR.MV_DATA_SOURCE_STATS (DATA_TYPE,ID,REVIEWED_PROTEIN_COUNT,UNREVIEWED_PROTEIN_COUNT,
                                       REFERENCED_PROTEOME_COUNT,PROTEOME_COUNT) VALUES
('ARBA','ARBA00000001',NULL,1914,NULL,NULL);
INSERT INTO SPTR.MV_DATA_SOURCE_STATS (DATA_TYPE,ID,REVIEWED_PROTEIN_COUNT,UNREVIEWED_PROTEIN_COUNT,
                                       REFERENCED_PROTEOME_COUNT,PROTEOME_COUNT) VALUES
('ARBA','ARBA00000002',NULL,1517,NULL,NULL);
INSERT INTO SPTR.MV_DATA_SOURCE_STATS (DATA_TYPE,ID,REVIEWED_PROTEIN_COUNT,UNREVIEWED_PROTEIN_COUNT,
                                       REFERENCED_PROTEOME_COUNT,PROTEOME_COUNT) VALUES
('ARBA','ARBA00000003',NULL,75424,NULL,NULL);
INSERT INTO SPTR.MV_DATA_SOURCE_STATS (DATA_TYPE,ID,REVIEWED_PROTEIN_COUNT,UNREVIEWED_PROTEIN_COUNT,
                                       REFERENCED_PROTEOME_COUNT,PROTEOME_COUNT) VALUES
('ARBA','ARBA00023492',NULL,1234,NULL,NULL);
INSERT INTO SPTR.MV_DATA_SOURCE_STATS (DATA_TYPE,ID,REVIEWED_PROTEIN_COUNT,UNREVIEWED_PROTEIN_COUNT,
                                       REFERENCED_PROTEOME_COUNT,PROTEOME_COUNT) VALUES
('ARBA','ARBA00023910',NULL,4321,NULL,NULL);
-- mv arba data ends --
